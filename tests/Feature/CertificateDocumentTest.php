    ...
    public function test_real_xlsx_and_pdf_are_generated_with_private_assets(): void
    {
        ...
        try {
            ...
            $paths[] = $xlsx = app(PazSalvoExcelService::class)->generate([
                ...
                'authorized_by_name' => 'Administrador General AAUD', 'authorized_signature_path' => config('paz-salvo.signature'),
                'general_admin_name' => 'Administrador General AAUD', 'general_admin_signature_path' => config('paz-salvo.signature'),
            ...
            $this->assertLessThanOrEqual(120, $logo->getHeight());
            $this->assertSame(Alignment::HORIZONTAL_LEFT, $sheet->getStyle('D14:J14')->getAlignment()->getHorizontal());
