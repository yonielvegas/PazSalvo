...
type Doc = { id:number; folio:string; client_number:string; holder_name:string; agency_name:string; generated_by_name:string; issued_at:string; expires_at:string; status:string; effective_status:string };
